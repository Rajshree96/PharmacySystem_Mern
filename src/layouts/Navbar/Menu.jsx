...
const medicines = [ {label: "Categories"}, {label: "Medicine Type"}, {label: "Units"}, {label: "Add Medicine"} ];
const manufactuer = [ {label: "Add Manufacturer"}, {label: "Manage Manufacturer"}, {label: "Manufacturer Ledger"} ];
const brands = [ {label: "Add Brand"}, {label: "Manage Brand"} ];
const suppliers = [ {label: "Add Supplier"}, {label: "Manage Supplier"}, {label: "Supplier Ledger"} ];
const purchases = [ {label: "Purchase"}, {label: "Manage Purchase"}, {label: "Purchase Peturn"} ];
const sales = [
    {label: "Sale Invoice"},
...
const banks = [ {label: "Add Bank"}, {label: "Manage Bank"}, {label: "Bank Transaction"} ];
const reports = [ {label: "Stock Report"}, {label: "Sales Report"}, {label: "Purchase Report"} ];
const searchs = [ {label: "Invoice"}, {label: "Medicine"}, {label: "Supplier"}, {label: "Purchase"} ];
