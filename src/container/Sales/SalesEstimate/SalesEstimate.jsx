...
function SalesEstimate({formType, selectedData, setSuccess}) {
    ...
    useEffect(() => {
        if (formType === "edit salesestimate" && selectedData) {
            ...
            setEstimateNo(selectedData.estimateNo);
            ...
            setOtherCharges(selectedData.amounts.otherCharge);
    ...
    const handleSaveSalesEstimate = async (e) => {
        ...
        try {
            if (formType === "edit salesestimate") {
                // await editSalesEstimate(selectedData._id, salesEstimateData);
                console.log("Sales Estimate updated successfully");
                setSuccess(true);
            ...
            <Paper sx={{p: 2, mb: 2, ...paperStyles}}>
                ...
                <Grid container spacing={2}>
                    <Grid item md={12} xs={12} sx={{display: "flex", justifyContent: "center", gap: "10px"}}>
                        ...
                        >
                            {formType === "edit salesestimate" ? "Update Estimate  " : "Save Estimate "}
                        </Button>
